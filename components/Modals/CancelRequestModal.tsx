...
export interface CancelRequestModalProps {
  ...
  cancelRequest: (form: any) => void;
  closeModal: () => void;
}

export const CancelRequestModal: React.FC<CancelRequestModalProps> = ({ requestData, visibility, transactionStatus, cancelRequest, closeModal }) => {
  return (
    <>
